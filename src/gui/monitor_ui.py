...
class MonitorApp:
    ...
    def _build_header(self, parent):
        ...
        Exibe: Ticker, Preço Atual, Timeframe, Status do Monitor
        """
        ...
        # Status do Monitor
        status_frame = ttk.Frame(info_container)
    ...
    def _build_controls(self, parent):
        ...
        Botão toggle Start/Stop para controlar o monitor.
        """
    ...
    def _build_logs_area(self, parent):
        ...
        Colunas: Data/Hora, Tipo, Preço, Probabilidade, Mensagem
        """
        ...
        # Configura colunas
        self.logs_tree.heading('datetime', text='Data/Hora')
    ...
    def _process_update(self, data: dict):
        ...
        """
        try:
            # Atualiza preço atual no header
            if 'price' in data:
